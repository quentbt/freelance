...
final class Version20230502164658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conversation (id INT AUTO_INCREMENT NOT NULL, discussion_id INT DEFAULT NULL, message LONGTEXT NOT NULL, INDEX IDX_8A8E26E91ADED311 (discussion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
