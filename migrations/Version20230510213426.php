 ...
 */
final class Version20230510213426 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_envoyeur_id INT DEFAULT NULL, user_receveur_id INT DEFAULT NULL, messagerie_id INT DEFAULT NULL, message LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_B6BD307F107C2FB3 (user_receveur_id), INDEX IDX_B6BD307FEE8E6E13 (user_envoyeur_id), INDEX IDX_B6BD307F836C1031 (messagerie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE messagerie (id INT AUTO_INCREMENT NOT NULL, messagerie_user_id INT DEFAULT NULL, INDEX IDX_14E8F60CEC5080E9 (messagerie_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
